...
public class PieceAdapters extends ArrayAdapter<Piece> {

    public PieceAdapters(Context context, ArrayList<Piece> pieces) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvName.setText(piece.getNamePiece());
        viewHolder.tvAdresse.setText(piece.getLieuPiece());
        viewHolder.tvType.setText(piece.getTypePiece());
        viewHolder.tvTelephone.setText(piece.getTelephoneReference());
